...
class MinimumUppercaseLettersValidatorTest(TestCase):
...
class MinimumLowercaseLettersValidatorTest(TestCase):
...
class MinimumDigitsValidatorTest(TestCase):
...
class MinimumSpecialCharactersValidatorTest(TestCase):
