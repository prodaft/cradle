...
class TokenObtainSerializerTest(TestCase):
    ...
    def setUp(self):
        ...
        self.normal_user = CradleUser.objects.create_user(username="user", password="pass1")
        self.admin_user = CradleUser.objects.create_superuser(username="admin", password="pass2")
