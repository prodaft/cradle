...
artifacts (evidence like IPs, domains, hashes). Entities drive access
control for notes and dashboards.
...
from note references, including related entities, related artifacts, and
