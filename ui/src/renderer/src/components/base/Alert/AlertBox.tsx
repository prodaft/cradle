 ...
 */
export type AlertColor = 'green' | 'red' | 'yellow' | 'success' | 'error' | 'warning' | 'info' | string;
 ...
 * ```
 */
export default function AlertBox({ alert, timeout }: AlertBoxProps): JSX.Element | null {
  ...
  const renderIcon = () => {
    const iconColor = normalizedColor === 'green' ? 'var(--cradle-accent-success)'
      : normalizedColor === 'red' ? 'var(--cradle-accent-error)'
      : normalizedColor === 'yellow' ? 'var(--cradle-accent-warning)' : 'var(--cradle-accent-primary)';
