...
export function NoteRetrieveFromJSONTyped(json: any, ignoreDiscriminator: boolean): NoteRetrieve {
    ...
    return {
        ...
        'author': EssentialUserRetrieveFromJSON(json['author']),
        'entries': json['entries'],
        'editTimestamp': json['edit_timestamp'] == null ? undefined : (new Date(json['edit_timestamp'])),
        'editor': EssentialUserRetrieveFromJSON(json['editor']),
...
export function NoteRetrieveToJSONTyped(value?: Omit<NoteRetrieve, 'id'|'entities'|'timestamp'> | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'author': EssentialUserRetrieveToJSON(value['author']),
        'entries': value['entries'],
        'edit_timestamp': value['editTimestamp'] === null ? null : ((value['editTimestamp'] as any)?.toISOString()),
        'editor': EssentialUserRetrieveToJSON(value['editor']),
