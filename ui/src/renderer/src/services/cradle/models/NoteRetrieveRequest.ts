...
import type { EssentialUserRetrieveRequest } from './EssentialUserRetrieveRequest';
import {
    EssentialUserRetrieveRequestFromJSON,
    EssentialUserRetrieveRequestFromJSONTyped,
    EssentialUserRetrieveRequestToJSON,
    EssentialUserRetrieveRequestToJSONTyped,
} from './EssentialUserRetrieveRequest';
...
export interface NoteRetrieveRequest {
    ...
    /**
     * 
     * @type {EssentialUserRetrieveRequest}
     * @memberof NoteRetrieveRequest
     */
    author: EssentialUserRetrieveRequest;
    /**
     * 
     * @type {Array<string>}
     * @memberof NoteRetrieveRequest
     ...
     * @memberof NoteRetrieveRequest
     */
    editor: EssentialUserRetrieveRequest;
    /**
     * 
     * @type {Date}
     * @memberof NoteRetrieveRequest
...
export function NoteRetrieveRequestFromJSONTyped(json: any, ignoreDiscriminator: boolean): NoteRetrieveRequest {
    ...
    return {
        ...
        'author': EssentialUserRetrieveRequestFromJSON(json['author']),
        'entries': json['entries'],
        'editTimestamp': json['edit_timestamp'] == null ? undefined : (new Date(json['edit_timestamp'])),
        'editor': EssentialUserRetrieveRequestFromJSON(json['editor']),
...
export function NoteRetrieveRequestToJSONTyped(value?: NoteRetrieveRequest | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'author': EssentialUserRetrieveRequestToJSON(value['author']),
        'entries': value['entries'],
        'edit_timestamp': value['editTimestamp'] === null ? null : ((value['editTimestamp'] as any)?.toISOString()),
        'editor': EssentialUserRetrieveRequestToJSON(value['editor']),
