...
import {
    ...
    PaginatedBaseDigestListFromJSON,
    PaginatedBaseDigestListToJSON,
} from '../models/index';
...
export interface IntelioDigestListRequest {
    author?: string;
    createdAt?: Date;
    createdAtGte?: string;
    createdAtLte?: string;
...
export class IntelioApi extends runtime.BaseAPI {
     ...
     * Manage digests
     */
    async intelioDigestListRaw(requestParameters: IntelioDigestListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedBaseDigestList>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginatedBaseDigestListFromJSON(jsonValue));
    }
     ...
     * Manage digests
     */
    async intelioDigestList(requestParameters: IntelioDigestListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginatedBaseDigestList> {
        const response = await this.intelioDigestListRaw(requestParameters, initOverrides);
        return await response.value();
    }
