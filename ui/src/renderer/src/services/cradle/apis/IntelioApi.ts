...
export class IntelioApi extends runtime.BaseAPI {
     ...
     */
    async enrichmentRelationsRetrieveRaw(requestParameters: EnrichmentRelationsRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedRelationSerializerResponse>> {
     ...
     * Retrieve relations created by enrichment
     */
    async enrichmentRelationsRetrieve(requestParameters: EnrichmentRelationsRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginatedRelationSerializerResponse> {
