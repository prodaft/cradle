...
export class NotesApi extends runtime.BaseAPI {
    ...
    async notesDeleteRaw(requestParameters: NotesDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['noteIdS'] == null) {
            throw new runtime.RequiredError(
                'noteIdS',
                'Required parameter "noteIdS" was null or undefined when calling notesDelete().'
            );
        }
        ...
        let urlPath = `/notes/{note_id_s}/`;
        urlPath = urlPath.replace(`{${"note_id_s"}}`, encodeURIComponent(String(requestParameters['noteIdS'])));
     ...
     */
    async notesFilesRetrieveRaw(requestParameters: NotesFilesRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FileReference>> {
        const queryParameters: any = {};
     ...
     * Get files from accessible notes
     */
    async notesFilesRetrieve(requestParameters: NotesFilesRetrieveRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FileReference> {
     ...
     */
    async notesListRaw(requestParameters: NotesListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NoteRetrieve>> {
        const queryParameters: any = {};
     ...
     * Get accessible notes
     */
    async notesList(requestParameters: NotesListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<NoteRetrieve> {
    ...
    async notesRetrieveRaw(requestParameters: NotesRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NoteRetrieve>> {
        if (requestParameters['noteIdS'] == null) {
            throw new runtime.RequiredError(
                'noteIdS',
                'Required parameter "noteIdS" was null or undefined when calling notesRetrieve().'
            );
        }
    ...
    async notesUpdateRaw(requestParameters: NotesUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<NoteRetrieve>> {
        if (requestParameters['noteIdS'] == null) {
            throw new runtime.RequiredError(
                'noteIdS',
                'Required parameter "noteIdS" was null or undefined when calling notesUpdate().'
            );
        }
