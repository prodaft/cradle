...
export class EntriesApi extends runtime.BaseAPI {
     ...
     */
    async entriesRelationsListRaw(requestParameters: EntriesRelationsListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<Relation>>> {
     ...
     * List relations between entries
     */
    async entriesRelationsList(requestParameters: EntriesRelationsListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<Relation>> {
