...
export class UsersApi extends runtime.BaseAPI {
    ...
    async usersLoginCreateRaw(requestParameters: UsersLoginCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TokenPairRetrieve>> {
        ...
        if (requestParameters['twoFactorToken'] != null) {
            formParams.append('two_factor_token', requestParameters['twoFactorToken'] as any);
        }
    ...
    async usersResetPasswordUpdateRaw(requestParameters: UsersResetPasswordUpdateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<any>> {
        if (requestParameters['token'] == null) {
            throw new runtime.RequiredError(
                'token',
                'Required parameter "token" was null or undefined when calling usersResetPasswordUpdate().'
            );
        }
        ...
        if (requestParameters['password'] == null) {
            throw new runtime.RequiredError(
                'password',
                'Required parameter "password" was null or undefined when calling usersResetPasswordUpdate().'
            );
        }
 ...
 * @export
 */
export const UsersCreateThemeEnum = {
    Dark: 'dark',
    Light: 'light'
} as const;
export type UsersCreateThemeEnum = typeof UsersCreateThemeEnum[keyof typeof UsersCreateThemeEnum];
/**
 * @export
 */
 ...
 * @export
 */
export const UsersUpdateThemeEnum = {
    Dark: 'dark',
    Light: 'light'
} as const;
export type UsersUpdateThemeEnum = typeof UsersUpdateThemeEnum[keyof typeof UsersUpdateThemeEnum];
