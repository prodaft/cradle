...
export interface QueryAdvancedRetrieveRequest {
    query: Array<string>;
    page?: number;
    pageSize?: number;
    wildcard?: boolean;
...
export class QueryApi extends runtime.BaseAPI {
     ...
     */
    async queryAdvancedRetrieveRaw(requestParameters: QueryAdvancedRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedEntryResponseSerializerResponse>> {
        if (requestParameters['query'] == null) {
            throw new runtime.RequiredError(
                'query',
                'Required parameter "query" was null or undefined when calling queryAdvancedRetrieve().'
            );
        }
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginatedEntryResponseSerializerResponseFromJSON(jsonValue));
    }
     ...
     * Advanced Query Entries
     */
    async queryAdvancedRetrieve(requestParameters: QueryAdvancedRetrieveRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginatedEntryResponseSerializerResponse> {
        const response = await this.queryAdvancedRetrieveRaw(requestParameters, initOverrides);
