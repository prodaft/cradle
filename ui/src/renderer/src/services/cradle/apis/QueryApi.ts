...
import type {
  EntryResponse,
  PaginatedPaginatedEntryResponseSerializerResponseList,
} from '../models/index';
import {
    EntryResponseFromJSON,
    EntryResponseToJSON,
    PaginatedPaginatedEntryResponseSerializerResponseListFromJSON,
    PaginatedPaginatedEntryResponseSerializerResponseListToJSON,
} from '../models/index';
...
export class QueryApi extends runtime.BaseAPI {
     ...
     * Query Entries
     */
    async queryListRaw(requestParameters: QueryListRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PaginatedPaginatedEntryResponseSerializerResponseList>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => PaginatedPaginatedEntryResponseSerializerResponseListFromJSON(jsonValue));
    }
     ...
     * Query Entries
     */
    async queryList(requestParameters: QueryListRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PaginatedPaginatedEntryResponseSerializerResponseList> {
