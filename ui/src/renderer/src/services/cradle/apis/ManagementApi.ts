...
export interface ManagementSettingsCreateRequest {
    requestBody?: { [key: string]: any; };
}
...
export class ManagementApi extends runtime.BaseAPI {
     ...
     */
    async managementSettingsCreateRaw(requestParameters: ManagementSettingsCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<{ [key: string]: any; }>> {
        const queryParameters: any = {};
     ...
     * Update one or more settings
     */
    async managementSettingsCreate(requestParameters: ManagementSettingsCreateRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<{ [key: string]: any; }> {
        const response = await this.managementSettingsCreateRaw(requestParameters, initOverrides);
        return await response.value();
    }
